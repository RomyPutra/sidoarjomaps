							...
							<div class="card-body" style="display: contents;">
								<div style="margin: 10px;">
									...
									<?php if (isset($tempat[0]->gambar) && $tempat[0]->gambar != '') {;?>
										<img src="<?php echo base_url('public/imgmain/').$tempat[0]->gambar;?>" class="card-img-top" alt="<?php echo $tempat[0]->nama;?>" style="width: 150px; height: 150px;margin-right:15px;margin-bottom: :15px;float: left;">
									<?php } else {;?>
										<img src="<?php echo base_url('public/imgmain/no-image.png');?>" class="card-img-top" alt="No Image" style="width: 150px; height: 150px;margin-right:15px;margin-bottom: :15px;float: left;">
									<?php };?>
