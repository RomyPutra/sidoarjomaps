<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List Images</h1>
                </div>
                <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <span>Nama: &nbsp;<?php echo $lokasi->nama?></span>
                </div>
                <div class="row">
                  <span>Lokasi: &nbsp;<?php echo $lokasi->alt_name?></span>
                </div>
                <div class="row">
                  <div class="btn-group">
                    <?php if ($images < 5) { ?>
                    <a href="<?php echo base_url('obyek/inputdtl/').$idlokasi;?>" class="btn btn-sm custom-button">
                        Tambah Data  &nbsp;
              ...
              <div class="card-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="tdatadtl">
                  <thead>
                    <tr>
