<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List Obyek</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Obyek</a></li>
                    </ol>
                </div>
            </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="btn-group">
                  <a href="<?php echo base_url('obyek/input')?>" class="btn btn-sm custom-button">
                      Tambah Data  &nbsp;
                ...
                <table class="table table-striped table-bordered table-hover" id="tdata">
                  <thead>
                    <tr>
                      ...
                      <th><div align="center">Profile</div></th>
                      <th><div align="center">Latitude</div></th>
                      <th><div align="center">Longitude</div></th>
