            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('kecamatanedu');?>">Kecamatan</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-success">
						<form action="<?php echo base_url('kecamatanedu/store');?>" method="post" enctype="multipart/form-data">
	                        ...
	                        <div class="card-body">
								...
								<a class="btn btn-danger" href="<?php echo base_url('kecamataneduedu');?>">Cancel</a>
	                        </div>
						</form>
                    </div>
                </div>
