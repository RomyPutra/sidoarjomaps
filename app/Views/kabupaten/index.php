<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List Kabupaten</h1>
                </div>
                <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="btn-group">
                  <!-- <a href="<?php echo base_url('kabupaten/input')?>" class="btn btn-sm custom-button">
                      Tambah Data  &nbsp;
                ...
                <table class="table table-striped table-bordered table-hover" id="tdata">
                  <thead>
                    <tr>
                      ...
                      <th><div align="center">Luas Wilayah</div></th>
                      <th><div align="center">Batas Utara</div></th>
                      <th><div align="center">Batas Barat</div></th>
                      <th><div align="center">Batas Selatan</div></th>
                      <th><div align="center">Batas Timur</div></th>
