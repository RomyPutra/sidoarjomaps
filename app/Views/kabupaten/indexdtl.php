          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="btn-group">
                  <a href="<?php echo base_url('kabupatendtl/input')?>" class="btn btn-sm custom-button">
                      Tambah Data  &nbsp;
                ...
                <table class="table table-striped table-bordered table-hover" id="tdata">
                  <thead>
                    <tr>
                      ...
                      <th><div align="center">Usia</div></th>
                      <th><div align="center">Jumlah Pria</div></th>
                      <th><div align="center">Jumlah Wanita</div></th>
