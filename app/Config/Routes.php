...
$routes->get('kabupaten', 'Kabupaten::index', ['filter' => 'authGuard']);
$routes->post('ajaxkabupaten', 'Kabupaten::ajaxkabupaten', ['filter' => 'authGuard']);
$routes->get('kabupaten/input', 'Kabupaten::input', ['filter' => 'authGuard']);
$routes->get('kabupaten/input/(:any)', 'Kabupaten::input/$1', ['filter' => 'authGuard']);
$routes->post('kabupaten/store', 'Kabupaten::store', ['filter' => 'authGuard']);
$routes->get('kabupatendtl', 'Kabupaten::indexdtl', ['filter' => 'authGuard']);
$routes->post('ajaxkabupatendtl', 'Kabupaten::ajaxkabupatendtl', ['filter' => 'authGuard']);
$routes->get('kabupatendtl/input', 'Kabupaten::inputdtl', ['filter' => 'authGuard']);
$routes->get('kabupatendtl/input/(:any)', 'Kabupaten::inputdtl/$1', ['filter' => 'authGuard']);
$routes->post('kabupatendtl/store', 'Kabupaten::storedtl', ['filter' => 'authGuard']);
$routes->get('kabupatenjob', 'Kabupaten::indexjob', ['filter' => 'authGuard']);
$routes->post('ajaxkabupatenjob', 'Kabupaten::ajaxkabupatenjob', ['filter' => 'authGuard']);
$routes->get('kabupatenjob/input', 'Kabupaten::inputjob', ['filter' => 'authGuard']);
$routes->get('kabupatenjob/input/(:any)', 'Kabupaten::inputjob/$1', ['filter' => 'authGuard']);
$routes->post('kabupatenjob/store', 'Kabupaten::storejob', ['filter' => 'authGuard']);
...
$routes->post('kecamatan/store', 'Kecamatan::store', ['filter' => 'authGuard']);
$routes->post('ajaxdropkota/(:any)', 'Kecamatan::getregency/$1', ['filter' => 'authGuard']);
$routes->get('kecamatanedu', 'Kecamatan::indexedu', ['filter' => 'authGuard']);
$routes->post('ajaxkecamatanedu', 'Kecamatan::ajaxkecamatanedu', ['filter' => 'authGuard']);
$routes->get('kecamatanedu/input', 'Kecamatan::inputedu', ['filter' => 'authGuard']);
$routes->get('kecamatanedu/input/(:any)', 'Kecamatan::inputedu/$1', ['filter' => 'authGuard']);
$routes->post('kecamatanedu/store', 'Kecamatan::storeedu', ['filter' => 'authGuard']);
$routes->get('kecamatanjob', 'Kecamatan::indexjob', ['filter' => 'authGuard']);
$routes->post('ajaxkecamatanjob', 'Kecamatan::ajaxkecamatanjob', ['filter' => 'authGuard']);
$routes->get('kecamatanjob/input', 'Kecamatan::inputjob', ['filter' => 'authGuard']);
$routes->get('kecamatanjob/input/(:any)', 'Kecamatan::inputjob/$1', ['filter' => 'authGuard']);
$routes->post('kecamatanjob/store', 'Kecamatan::storejob', ['filter' => 'authGuard']);
...
$routes->get('obyek/deleteobj/(:num)', 'Lokasi::delobyek/$1', ['filter' => 'authGuard']);
